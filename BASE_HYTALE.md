...
- **23/07/2026 — Update 6 Parte 9, MODO HARDCORE** (notas da pré-release). Só ativa ao criar mundo novo, não muda depois; sem respawn, larga tudo e vira Spectator (invisível, sem interagir); comando /spectate. Também, docs com domínio novo (docs.hytale.com e pre-release.docs.hytale.com), stamina recarrega mais rápido após guardar, blend de cor entre biomas, terra vira meia-laje, e correção do bug "as estrelas da noite estavam quebrando". Contribuidor NoctuaAstrum.
- **19-22/07/2026 — a falha de segurança era um RCE (bounty de 20 mil, o maior do jogo).** Contado pelo @DevSlashNulled (x.com/DevSlashNulled/status/2080048379363569792). Um servidor malicioso podia mandar um PNG preparado e, no pior caso, rodar código na máquina do jogador conectado. Corrigido no mesmo dia (build 0.5.7 20), sem evidência de uso contra jogadores; reforçaram o resto do código. Detalhe técnico (writeup do pesquisador @0x90sh em 0x90.sh/threads/how-a-png-became-a-20-000-hytale-rce.57), integer overflow no tamanho do PNG -> buffer overflow -> cadeia de objetos falsos em C#/NativeAOT alcançando um helper do Sentry que abria cmd.exe (PoC abriu a calculadora). Vídeo da PoC baixado em Downloads/EldrynMidias/hytale-rce/. Passkeys entraram nas contas (20/07). Programa de bounty em hytale.com/security. NÃO ser alarmista, já corrigido.

- **23/07/2026 — COMO O SIMON BANCA O JOGO** (x.com/Simon_Hypixel/status/2080356090080895325, 179 curtidas). Literal: quando vendeu o Hytale pra Riot em 2020, **investiu tudo na grande queda do mercado** e se deu muito bem nos anos seguintes; **hoje tem várias empresas e um fundo de investimento**, e foi essa estratégia que permitiu **recomprar o jogo**. "I'm not worried about funding at all. Right now, my only focus is on making a good game." Fecho: **"Hytale is my retirement passion project"**, compara com comprar um time esportivo, diz que odiava a aposentadoria parada e que está vivendo a melhor fase da vida. Complementa o fato dos 10 anos de financiamento próprio.
...
- **Fluid/Water rework** (Slikey, 26/07/2026, repostado pelo Simon): diretor técnico anunciou retrabalho dos fluidos/água e pediu opinião da comunidade pra definir requisitos do motor. Primeiro alvo, consertar buracos na água ao usar balde/quebrar bloco. Perguntas abertas, água finita vs infinita, espalhamento, física afetando mob/item, interação água/lava/lama, fluido novo por modders. Ideias citadas, cachoeira, correnteza de rio, clima mudando visual (calma/agitada), vapor que inverte gravidade. Bloco vs visual suave em aberto. Vai montar roadmap com o feedback.
